...
async def execute(
    ...
    return {"status": "success", "finite_prompt": finite_prompt, "length": len(finite_prompt), "updated_content": OpenAIService.generate_response_by_prompt(prompt=finite_prompt, openai_key="")}
